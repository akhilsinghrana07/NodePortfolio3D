    ...
    <section className="certificate" id="certificate">
      ...
      <div className="column-container">
        <div className="column">
          ...
          <div >
            <img className='certimg' src={c1} alt="Company 1 certificate" />
          </div>
        </div>
        <div className="column">
          <div className="image">
          ...
          <div >
            <img className='certimg' src={c2} alt="Company 2 certificate" />
          </div>
        </div>
        <div className="column">
          <div className="image">
          ...
          <div >
            <img className='certimg' src={c3} alt="Company 3 certificate" />
          </div>
        </div>
      </div>
    </section>
